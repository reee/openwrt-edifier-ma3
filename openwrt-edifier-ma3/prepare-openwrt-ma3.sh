...
echo "Adding Edifier MA3 SoM support to OpenWrt"

# Kernel support
cp -v -n $SCRIPT_DIR/mt7628an_edifier_ma3.dts ./target/linux/ramips/dts/
patch -p1 < $SCRIPT_DIR/mt7628an_edifier_ma3-mk.diff
